...
Гашение по когерентности пришлось научить тому же: тензор, собранный из одной
яркости, не находит направления там, где меняется только цвет, и чистка выбросила
бы ровно те чернила, которые цветовые оси только что добыли. Поэтому при включённом
цвете тензор суммирует произведения по всем трём каналам — форма Ди Дзенцо, — и
гашение смотрит туда же, куда смотрел детектор.
