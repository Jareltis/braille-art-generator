...
мегапикселя против 21 мс у следующего за ним гистерезиса. Два способа удешевить
были измерены, и ни один не взят: половинное разрешение вчетверо быстрее и
сдвигает 30% зажжённых точек, а коробочные размытия вместо гауссова вдвое
быстрее и меняют саму когерентность на 0.07–0.14 по шкале до единицы. Цену вместо
...
контрасту, брать локальный порог, рисовать линии, смешивать линии с тоном. Из
какого семейства плитка — решается первым, случайны только его ручки: метод
внутри семейства, детализация, радиус и вес контура, а также порог в пределах
примерно двадцати уровней от текущего.
