...
Если пойти дальше и позволить цвету выбирать сам рисунок — разделив восемь точек
ячейки между двумя красками, которые к ним ближе всего, — выходит **2.0–3.8**.
Но это уже другая картинка: арт перестаёт читаться как тон и становится мозаикой.
Это измерено и отложено в отдельный режим, а не подмешано в этот.
